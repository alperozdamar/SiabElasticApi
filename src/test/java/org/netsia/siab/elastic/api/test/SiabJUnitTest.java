...
public class SiabJUnitTest {
	...
	public static final String expectedGeneratedJsonBody = "{\"query\":{\"bool\":{\"must\":[{\"match\":{\"serial_number\":\"PSMO12345678\"}},{\"match\":{\"serial_number\":\"PSMO12345678\"}},{\"match\":{\"type\":\"cord-kafka\"}}],\"filter\":[{\"range\":{\"timestamp\":{\"gte\":\"1542672000\"}}},{\"range\":{\"timestamp\":{\"lte\":\"1544837131937\"}}},{\"term\":{\"kafka_topic\":\"onu.events\"}}]}}}";
	...
	public void test_JsonGeneration_SearchServlet() {
		...
		try {
			...
			assertEquals("", generatedJsonString, "");
